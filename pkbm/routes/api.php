...
//pendaftaran
Route::get('/pendaftaran', [App\Http\Controllers\Api\PendaftaranController::class, 'index']);
Route::get('/homepage/pendaftaran', [App\Http\Controllers\Api\PendaftaranController::class, 'PendaftaranHomepage']);
