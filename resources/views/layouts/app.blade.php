...
<head>
    ...
    <title>Dashboard &mdash; PKBM Kabupaten Tegal</title>
        ...
        <div class="main-wrapper main-wrapper-1">
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a style="color: white;" href="index.html">Administrator</a>
                    </div>
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a style="color: white;" href="index.html">PKBM</a>
                    </div>
                    <ul class="sidebar-menu">
                        ...
                        <li class="{{ setActive('admin/pendaftaran') }}"><a class="nav-link"
                                href="{{ route('admin.pendaftaran.index') }}"><i class="fas fa-book"></i> <span>Pendaftaran</span></a>
                        </li>
                        @endcan

                        <!-- @can('riwpendaftarans.index')
                        <li class="{{ setActive('admin/riwpendaftaran') }}"><a class="nav-link"
                                href="{{ route('admin.riwpendaftaran.index') }}"><i class="fas fa-book"></i> <span>Riwayat Pendaftaran</span></a>
                        </li>
                        @endcan -->

                        @can('pkbms.index')
                        <li class="{{ setActive('admin/pkbm') }}"><a class="nav-link"
                                href="{{ route('admin.pkbm.index') }}"><i class="fas fa-folder"></i>
                                <span>Pkbm</span></a></li>
                        @endcan
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2018 <div class="bullet"></div> PKBM Kabupaten Tegal <div class="bullet"></div> All Rights
                    Reserved.
                </div>
