...
Route::get('/berita', [App\Http\Controllers\User\BeritaController::class, 'index']);
Route::get('/berita/{slug}', [App\Http\Controllers\User\BeritaController::class, 'detail']);
...
Route::prefix('admin')->group(function () {
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        //pendaftaran
        Route::resource('/pendaftaran', App\Http\Controllers\Admin\PendaftaranController::class, ['except' => 'show', 'as' => 'admin']);


        Route::resource('/pkbm', App\Http\Controllers\Admin\PkbmController::class, ['except' => 'show', 'as' => 'admin']);

        // Route::get('/pendaftaran', [App\Http\Controllers\Admin\PendaftaranController::class, 'create'])->name('admin.pendaftaran.create');



        // //riwayat pendaftaran
        // Route::resource('/riwpendaftaran', App\Http\Controllers\Admin\RiwpendaftaranController::class, ['except' => ['show', 'create', 'edit', 'update'] ,'as' => 'admin']);
