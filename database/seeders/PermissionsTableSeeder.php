...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //permission for pendaftarans
        Permission::create(['name' => 'pendaftarans.index']);
        Permission::create(['name' => 'pendaftarans.create']);
        Permission::create(['name' => 'pendaftarans.edit']);
        Permission::create(['name' => 'pendaftarans.delete']);

        Permission::create(['name' => 'pkbms.index']);
        Permission::create(['name' => 'pkbms.create']);
        Permission::create(['name' => 'pkbms.edit']);
        Permission::create(['name' => 'pkbms.delete']);

        //permission for riwayat pendaftaran
        // Permission::create(['name' => 'riwpendaftaran.index']);
        // Permission::create(['name' => 'riwpendaftaran.create']);
        // Permission::create(['name' => 'riwpendaftaran.delete']);
